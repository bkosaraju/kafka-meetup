...
CREATE CATALOG iceberg_catalog_2 WITH (
  'type'='iceberg',
  'catalog-type'='rest',
  'uri'='http://iceberg-rest:8181/',
  's3.endpoint' = 'http://minio:9000',
...
select * from iceberg_catalog.test_db_4.transactions.snapshots;
...
select * from iceberg_catalog.test_db_5.transactions  /*+ OPTIONS('streaming'='false')*/ where `transactionId` is not null ;